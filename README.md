...
<h1 align="center">GeoBasis_Loader (GBL)</h1>
...
- Zugriff auf Geodienste aller 16 Bundesländer sowie Europa-, Welt- und ausgesuchte Spezial-Kataloge
...
- Presets (Zusammenstellungen) für häufig genutzte Dienst-Kombinationen
...
### Variante 1: Über den QGIS Plugin Manager (empfohlen)
...
## Presets (Zusammenstellungen)

Häufig genutzte Dienst-Kombinationen lassen sich als Presets (Zusammenstellungen) markieren

1. Im Menü des GBL rechte Maustaste auf das gewünschte Thema und das Thema "zu Preset hinzufügen" oder "vom Preset entfernen"
2. Ein Themen-Zusammenstellung im aktuellen Projekt als Preset abspreichern über: Schaltfläche GBL und "Presets / Neu vom Projekt"
...
- **GBL-Supporter** werden und mit einer Spende die Entwicklung sowie die Pflege der Kataloge unterstützen 
...
- **Anton May & Thomas Wölk** &mdash; für die Unterstützung bei der Entwicklung
...
- Allen Wissenden, die uns auf neue und aktualisierte URLs hinweisen 
- Allen bisherigen Sponsoren für die finanzielle Untersützung des Projektes 
